"""Validation run for flat LCDM with Pantheon+."""
...
def main(argv: list[str] | None = None) -> int:
    """Run flat LCDM against the official Pantheon+ likelihood."""

    parser = argparse.ArgumentParser()
    parser.add_argument(
        "--output-root",
        type=Path,
        default=Path("outputs/validation_pantheonplus_lcdm"),
        help="Parent directory for Pantheon+ validation artifacts.",
    )
    parser.add_argument(
        "--overwrite",
        action="store_true",
    ...
    run_config = RunConfig(
        ...
        runtime=RuntimeConfig(
            run_label="validation-pantheonplus-lcdm",
