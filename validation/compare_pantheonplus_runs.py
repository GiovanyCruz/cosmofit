"""Compare CosmoFit and direct-Cobaya Pantheon+ chains."""
...
def newest_cosmofit_root() -> Path:
    """Return the newest CosmoFit Pantheon+ chain root."""

    parent = Path(
        "outputs/validation_pantheonplus_lcdm"
    )
    ...
    if not run_directories:
        raise FileNotFoundError(
            "No CosmoFit Pantheon+ validation runs found."
        )
...
def relative_difference(
    ...
    """Return the symmetric relative percentage difference."""
...
def normalized_mean_difference(
    ...
    """Return mean separation in combined-sigma units."""
